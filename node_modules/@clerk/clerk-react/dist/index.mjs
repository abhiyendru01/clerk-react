...
var Portal = class extends React7.PureComponent {
  ...
  render() {
    ...
    return /* @__PURE__ */ React7.createElement(React7.Fragment, null, !hideRootHtmlElement && /* @__PURE__ */ React7.createElement("div", { ref: this.portalRef }), this.props.children);
  }
};
...
var _UserButton = withClerk(
  ({ clerk, ...props }) => {
    ...
    return /* @__PURE__ */ React7.createElement(UserButtonContext.Provider, { value: passableProps }, /* @__PURE__ */ React7.createElement(
      Portal,
      {
        ...passableProps,
...
function UserButtonOutlet(outletProps) {
  ...
  return /* @__PURE__ */ React7.createElement(Portal, { ...portalProps });
}
...
var _OrganizationSwitcher = withClerk(
  ({ clerk, ...props }) => {
    ...
    return /* @__PURE__ */ React7.createElement(OrganizationSwitcherContext.Provider, { value: passableProps }, /* @__PURE__ */ React7.createElement(
      Portal,
      {
        ...passableProps,
        hideRootHtmlElement: !!props.__experimental_asProvider
...
function ClerkContextProvider(props) {
  ...
  const clerkCtx = React12.useMemo(() => ({ value: clerk }), [clerkLoaded]);
  const clientCtx = React12.useMemo(() => ({ value: state.client }), [state.client]);
  const {
    sessionId,
    session,
    userId,
  ...
  const sessionCtx = React12.useMemo(() => ({ value: session }), [sessionId, session]);
  const userCtx = React12.useMemo(() => ({ value: user }), [userId, user]);
  ...
  return (
    ...
    /* @__PURE__ */ React12.createElement(IsomorphicClerkContext.Provider, { value: clerkCtx }, /* @__PURE__ */ React12.createElement(ClientContext.Provider, { value: clientCtx }, /* @__PURE__ */ React12.createElement(SessionContext.Provider, { value: sessionCtx }, /* @__PURE__ */ React12.createElement(OrganizationProvider, { ...organizationCtx.value }, /* @__PURE__ */ React12.createElement(AuthContext.Provider, { value: authCtx }, /* @__PURE__ */ React12.createElement(UserContext.Provider, { value: userCtx }, children))))))
  );
}
