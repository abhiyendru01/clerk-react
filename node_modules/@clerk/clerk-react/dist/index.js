...
__export(src_exports, {
  ...
  useReverification: () => import_react18.useReverification,
...
var Portal = class extends import_react11.default.PureComponent {
  ...
  render() {
    ...
    return /* @__PURE__ */ import_react11.default.createElement(import_react11.default.Fragment, null, !hideRootHtmlElement && /* @__PURE__ */ import_react11.default.createElement("div", { ref: this.portalRef }), this.props.children);
  }
};
...
var _UserButton = withClerk(
  ({ clerk, ...props }) => {
    ...
    return /* @__PURE__ */ import_react11.default.createElement(UserButtonContext.Provider, { value: passableProps }, /* @__PURE__ */ import_react11.default.createElement(
      Portal,
      {
        ...passableProps,
...
function UserButtonOutlet(outletProps) {
  ...
  return /* @__PURE__ */ import_react11.default.createElement(Portal, { ...portalProps });
}
...
var _OrganizationSwitcher = withClerk(
  ({ clerk, ...props }) => {
    ...
    return /* @__PURE__ */ import_react11.default.createElement(OrganizationSwitcherContext.Provider, { value: passableProps }, /* @__PURE__ */ import_react11.default.createElement(
      Portal,
      {
        ...passableProps,
        hideRootHtmlElement: !!props.__experimental_asProvider
...
function useDerivedAuth(authObject) {
  ...
  const derivedHas = (0, import_react14.useCallback)(
    (params) => {
      if (has) {
        return has(params);
      }
...
var import_react17 = require("@clerk/shared/react");
