...
const Home = () => {
    ...
    return (<div style={styles.homeContainer}>
      <SignedIn>
        ...
        <div style={styles.mainContent}>
          <div style={styles.feed}>
            {images.map((image, index) => (<div key={index} style={styles.post}>
                <div style={styles.postHeader}>
                  <span style={styles.username}>{userNames[index]}</span>
                </div>
                <img style={styles.postImage} src={image} alt={`Painting ${index + 1}`}/>
                <div style={styles.postCaption}>
                  <textarea style={styles.captionInput} value={captions[index]} onChange={(e) => handleCaptionChange(index, e.target.value)} placeholder="Write a caption about your painting"/>
                </div>
                <div style={styles.postActions}>
                  <button style={styles.likeBtn} onClick={() => handleLike(index)}>
                    ❤️
                  </button>
